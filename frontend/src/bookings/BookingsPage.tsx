...
export function BookingsPage() {
  ...
  const eventData = useMemo(() => (slots.data || []).flatMap((slot) => slot.calendars.map((entry) => ({
    id: `${slot.start_at}:${entry.calendar_id}`,
    start: slot.start_at,
    end: entry.end_at,

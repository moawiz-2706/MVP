import { Bell, CalendarDays, ChevronLeft, MapPin, Menu, Settings, Shapes, Users, Warehouse, X } from "lucide-react";
import { useState } from "react";
import { NavLink, Outlet, useNavigate } from "react-router-dom";
import { useQuery } from "@tanstack/react-query";
import { useSession } from "../auth/GHLSessionProvider";
import { api } from "../api/client";
import type { BookingNotificationsResponse } from "../api/types";
...
function NotificationBell() {
  ...
  const notifications = useQuery({
    ...
    queryFn: () => api<BookingNotificationsResponse>("/booking-notifications"),
